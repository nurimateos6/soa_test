...
class alumno extends modeloDAO
{
  ...
  public $id; //id unica del alumno, creada por el usuarioa su conveniencia
  public $nombre;      //Nombre del alumno o Nombre Comercial de la empresa
  public $apellidos;   //Apellidos del alumno o Razón Social de la empresa
  public $nivel;       //nivel 
